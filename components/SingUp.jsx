      ...
      <div className="w-80 m-auto ">
        ...
        <div className="flex flex-row ml-9 sm:ml-0">
          <input
            ...
            className="border border-primary rounded text-primary text-sm w-28 sm:w-30 h-10 bg-secondary"
          />
          <span className="mr-6" />
          <input
            placeholder="   Last Name   "
            className="border mb-6 border-primary rounded text-primary text-sm w-28 w-30 h-10 bg-secondary"
          />
        </div>
        <button
          type="submit"
