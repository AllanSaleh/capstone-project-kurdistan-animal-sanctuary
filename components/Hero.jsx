...
function Hero() {
  ...
  return (
    <div className="bg-white w-80 md:w-96 h-96 mb-10 md:mb-32 m-">
      ...
      <div className=" text-center mt-32 z-20 right-20 absolute tracking-widest text-xl md:text-3xl px-0 md:px-20 z-4">
        <p className="font-black uppercase text-primary text-5xl mb-2 ">
          {t("homePage.whyAdopt")}
        </p>
        <p className="font-black uppercase text-primary mb-8 ">
          {t("homePage.adoptNow")}
        </p>
        <form action="/AdoptThePerfectPet">
          <button
            className=" py-2  px-20 font-semibold rounded-lg  text-primary bg-highlight hover:bg-darken"
            type="submit"
          >
